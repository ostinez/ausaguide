...
const BASE_URL = __ENV.BASE_URL || 'https://ausaguide.com';
...
export function viewSingleTour() {
  ...
  check(res, {
    'view single tour status is 200': (r) => r.status === 200,
  });
  sleep(1.5);
}

// Scenario 3: Book Tours (simulating loading the checkout page)
