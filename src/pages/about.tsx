...
export default function AboutPage() {
 ...
 <div className="flex size-12 items-center justify-center rounded-xl bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 text-[#0D6F73]">
 ...
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 text-xs font-semibold text-[#0D6F73]">
 ...
 >
 <div className="bg-card shadow-modern border border-border rounded-2xl overflow-hidden relative">
 <img
 ...
 <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 text-[#0D6F73]">
 ...
 <SpotlightCard className="p-8 border border-border bg-card shadow-modern rounded-2xl space-y-3 flex flex-col justify-between hover:border-[#0D6F73]/40 transition duration-300">
 <div className="space-y-3">
 <span className="text-[10px] font-bold uppercase tracking-wider text-[#0D6F73]">
 ✧ The Memory
 </span>
 ...
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-px bg-gradient-to-r from-transparent via-[#0D6F73]/40 to-transparent" />
 ...
 className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#0D6F73] hover:text-[#0D6F73]/80 hover:underline transition duration-300"
 >
 ...
 <div className="flex size-14 items-center justify-center rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 text-[#0D6F73] text-xl font-bold mb-4">
 1
 </div>
 ...
 backgroundColor="#121214"
 >
 <div className="p-8 sm:p-10 bg-card shadow-modern border border-border rounded-3xl flex flex-col md:flex-row items-center gap-8 md:gap-10 hover:border-border transition duration-300">
 {/* Photo Column */}
 <div className="relative shrink-0">
 <div className="size-32 sm:size-40 rounded-full p-1 bg-gradient-to-br from-[#0D6F73] via-[#0D6F73]/50 to-[#0D6F73] shadow-[0_0_20px_rgba(13, 111, 115,0.25)]">
 <img
 src={founderPhoto}
 alt="Austin M. Mbote"
 ...
 />
 <div className="absolute inset-0 bg-black/85 -[1px]" />
 ...
 {!isAuthenticated && (
 <StarBorder as={Link} to="/auth?tab=signup" color="#0D6F73" className="w-full sm:w-auto rounded-full overflow-hidden">
 <div className="px-8 py-3 text-sm font-bold text-white bg-card flex items-center justify-center gap-1.5">
 Sign Up Now
 ...
 <StarBorder as={Link} to="/tours" color="#0D6F73" className="w-full sm:w-auto rounded-full overflow-hidden">
 <div className="px-8 py-3 text-sm font-bold text-white bg-card flex items-center justify-center gap-1.5">
 Browse Tours
 <ArrowRight className="size-4" />
 </div>
