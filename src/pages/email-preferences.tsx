...
export default function EmailPreferencesPage() {
 ...
 <div className="rounded-2xl border border-border/60 bg-card shadow-modern p-6 shadow-[var(--shadow-3)] space-y-5">
 ...
 <div className="rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 p-4">
 <CheckCircle2 className="size-10 text-[#0D6F73]" />
 </div>
 <div>
 ...
 <div className={`size-9 rounded-full flex items-center justify-center ${optIn ? "bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15" : "bg-card shadow-modern"}`}>
 {optIn ? (
 <Bell className="size-4 text-[#0D6F73]" />
 ) : (
 ...
 optIn ? "bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon" : "bg-card shadow-modern"
 }`}
 >
 <span
 ...
 <div className="flex items-center gap-3">
 <div className="size-9 rounded-full flex items-center justify-center bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15">
 <Mail className="size-4 text-[#0D6F73]" />
 </div>
 <div>
 ...
 <span className="text-[10px] font-bold text-[#0D6F73] bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 px-2 py-0.5 rounded-full">
 Always On
 </span>
 </div>
 </div>
 ...
 onClick={handleSave}
 disabled={loading}
 className="w-full py-3 rounded-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold shadow-lg hover:opacity-90 disabled:opacity-50 transition flex items-center justify-center gap-2"
 >
 {loading ? (
