...
export default function JournalPage() {
 ...
 <div className="space-y-4 rounded-2xl border border-border/60 bg-card shadow-modern p-5">
 ...
 <Button
 className="w-full rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon hover:bg-[#6b47d6] text-white font-semibold"
 onClick={handleSave}
 disabled={saving}
 >
 ...
 <div
 key={j.id}
 className="group relative rounded-2xl border border-amber-500/10 bg-[#1d1b18]/45 overflow-hidden hover:border-amber-500/30 transition-all duration-300 shadow-md shadow-amber-950/20"
 >
 ...
 <button onClick={() => openEdit(j)} className="p-1.5 rounded-lg hover:bg-card shadow-modern text-amber-500/60 hover:text-amber-400 transition-colors">
