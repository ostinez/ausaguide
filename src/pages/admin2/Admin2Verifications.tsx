...
export default function Admin2Verifications() {
 ...
 className={cn(
 "px-4 py-2 text-xs font-semibold rounded-lg transition-colors border border-transparent",
 activeTab === 'all' ? "bg-card shadow-modern border-white/10 text-white" : "text-gray-400 hover:text-white"
 )}
 >
 ...
 <thead className="text-xs text-gray-400 bg-black/40 uppercase sticky top-0 z-10 ">
 <tr>
 ...
 className="px-2.5 py-1.5 bg-card shadow-modern hover:bg-card shadow-modern text-gray-300 rounded flex items-center gap-1 text-xs transition-colors"
 ...
 target="_blank" 
 rel="noreferrer"
 className="px-2.5 py-1.5 bg-card shadow-modern hover:bg-card shadow-modern text-gray-300 rounded text-xs transition-colors"
 >
 Verify on TRA
 </a>
 <button
 ...
 <div className="mb-4 bg-card shadow-modern p-3 rounded-lg text-xs border border-white/5 shrink-0">
 ...
 {/* Marker dot */}
 <span className="absolute -left-[27px] top-1.5 flex h-3 w-3 items-center justify-center rounded-full bg-gradient-to-br from-[#0D6F73] to-[#0D6F73]" />
 ...
 <button
 onClick={() => setSelectedHostHistory(null)}
 className="px-4 py-2 bg-card shadow-modern hover:bg-card shadow-modern text-sm font-semibold rounded-lg text-white transition-colors"
 >
 Close Window
 </button>
 </div>
