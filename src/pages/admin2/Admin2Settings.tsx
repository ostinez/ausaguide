...
export default function Admin2Settings() {
 ...
 <button
 onClick={handleReset}
 className="flex items-center gap-2 px-3 py-1.5 bg-card shadow-modern hover:bg-card shadow-modern text-gray-400 hover:text-white rounded-lg border border-white/10 text-sm transition-colors"
 >
 <RefreshCw size={14} />
 Reset
 </button>
