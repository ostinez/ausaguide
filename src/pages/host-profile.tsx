...
export default function HostProfilePage() {
 ...
 aria-label="Go back"
 className="inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium text-white/60 hover:text-white hover:bg-card shadow-modern border border-transparent hover:border-white/10 transition-all duration-200 active:scale-95 min-h-[44px]"
 >
 ...
 <Badge className="bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 border border-[#0D6F73]/40 text-[#0D6F73] hover:bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/25">
 Local Host
 </Badge>
 )}
 {profile.is_verified && (
