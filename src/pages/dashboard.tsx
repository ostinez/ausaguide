...
function UrgentRequestsSection({
 ...
 return (
 <Card className="border-brand/30 bg-card shadow-modern border rounded-2xl">
 <CardHeader className="pb-2">
 <CardTitle className="text-foreground font-bold text-base flex items-center gap-1.5">
 <Bell className="size-4 text-brand inline shrink-0 animate-bounce" />
 ...
 <span className="bg-brand/15 text-brand px-2 py-0.5 rounded-full capitalize font-semibold">
 ...
 className="flex-1 sm:flex-initial text-brand hover:text-brand hover:bg-brand/15 rounded-xl font-semibold"
 >
 <MessageSquare className="size-4 mr-1" />
 Chat
 </Button>
...
export default function DashboardPage() {
 ...
 // Subscribe to bookings updates in real-time
 const bookingChannel = supabase
 .channel(`bookings-updates-${userId || "anon"}`)
 .on(
 "postgres_changes",
 ...
 .channel(`notifications-updates-${userId || "anon"}`)
 .on(
 "postgres_changes",
 ...
 }, [userRoleState, navigate, loadDashboard, userId])
 ...
 <div className="rounded-xl border border-white/10 bg-card shadow-modern p-4 flex items-start gap-3">
