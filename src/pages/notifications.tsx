...
export default function NotificationsPage() {
 ...
 <button
 onClick={() => navigate(-1)}
 className="p-2 hover:bg-card shadow-modern rounded-full text-muted-foreground hover:text-white transition-colors"
 title="Back"
 >
 ...
 <div className="flex flex-col items-center justify-center py-20 gap-3 border border-white/5 bg-card shadow-modern rounded-2xl p-6">
 <div className="size-14 rounded-full bg-card shadow-modern flex items-center justify-center">
 ...
 notif.read
 ? "border-white/5 bg-card shadow-modern hover:bg-card shadow-modern text-muted-foreground"
