...
function SignInForm() {
 ...
 {infoMessage && (
 <div className="flex items-start gap-2 rounded-xl border border-[#0D6F73]/30 bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 p-3 text-xs font-semibold text-[#0D6F73] animate-in fade-in">
 ...
 type="button"
 onClick={handleResendConfirmation}
 className="text-xs text-muted-foreground hover:text-[#0D6F73] transition-colors underline focus:outline-none cursor-pointer"
 >
...
function SignUpForm() {
 ...
 <div className="flex items-start gap-2 rounded-xl border border-[#0D6F73]/30 bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 p-3 text-xs font-semibold text-[#0D6F73]">
 <CheckCircle2 className="size-4 shrink-0 mt-0.5" />
 <span>{infoMessage}</span>
 </div>
 {showResendButton && (
 ...
 className="text-xs font-bold text-[#0D6F73] hover:underline cursor-pointer flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:no-underline"
 >
 ...
 className="rounded border-border text-primary focus:ring-primary size-4 accent-[#0D6F73]"
 />
...
export default function AuthPage() {
 ...
 <div className="mt-2 text-xs font-semibold text-[#0D6F73] px-2.5 py-1 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 inline-block">
