...
function ChartTooltip({ active, payload, label }: any) {
 ...
 return (
 <div className="rounded-xl border border-border/60 bg-background/95 p-3 shadow-xl text-xs">
...
export default function AdminDashboard() {
 ...
 className="pl-10 border-border/70 bg-card shadow-modern" />
 </div>
 ...
 <TabsList className="grid w-full grid-cols-9 h-auto bg-card shadow-modern border border-border/40">
 ...
 {/* Revenue chart */}
 <Card className="border-border/60 bg-card shadow-modern ">
 <CardHeader>
 <CardTitle className="flex items-center gap-2 text-base text-white">
 <span className="size-2 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon inline-block" />
 ...
 <stop offset="5%" stopColor="#0D6F73" stopOpacity={0.3} />
 <stop offset="95%" stopColor="#0D6F73" stopOpacity={0} />
 </linearGradient>
 </defs>
 <CartesianGrid strokeDasharray="3 3" stroke="oklch(0.3 0.01 285)" vertical={false} />
 <XAxis dataKey="date" tick={{ fontSize: 10, fill: "oklch(0.7 0.02 260)" }}
 ...
 <Tooltip content={<ChartTooltip />}
 cursor={{ stroke: "#0D6F73", strokeWidth: 1, strokeDasharray: "4 4" }} />
 <Area type="monotone" dataKey="amount" stroke="#0D6F73"
 ...
 {/* Bookings trends */}
 <Card className="border-border/60 bg-card shadow-modern lg:col-span-2">
 <CardHeader>
 ...
 p.role === "host" ? "bg-brand/15 text-brand border border-brand/30" :
 ...
 <CardHeader>
 <CardTitle className="text-base font-bold flex items-center gap-2 text-white">
 <ClipboardList className="size-4 text-[#0D6F73]" />
 ...
 <td className="px-4 py-3">
 <span className="px-2.5 py-0.5 rounded-full text-[9px] font-bold tracking-wide uppercase bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 text-[#0D6F73] border border-[#0D6F73]/20">
 {w.role}
 </span>
 </td>
 <td className="px-4 py-3 text-white/60">
 ...
 <a href={h.license_upload_url} target="_blank" rel="noreferrer" className="text-[#0D6F73] underline hover:text-[#0D6F73]/80">
 ...
 className="text-[#0D6F73] underline hover:text-[#0D6F73]/80 font-medium text-xs">
 View License Document
 </button>
 ) : (
 ...
 <BadgeCheck className="size-5 text-[#0D6F73]" />
 ...
 <code className="text-[#0D6F73] font-mono font-semibold">{p.tra_number}</code>
 </div>
 {p.kpsga_number && (
 <div>
 <span className="text-muted-foreground">KPSGA: </span>
 <code className="text-[#0D6F73] font-mono font-semibold">{p.kpsga_number}</code>
 </div>
 )}
 {p.license_expiry && (
 ...
 className="text-[10px] text-[#0D6F73] hover:bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 h-7 px-2.5 rounded-full flex items-center gap-1"
 >
 ...
 className="w-full bg-card shadow-modern border border-border/60 rounded-xl px-3 py-2 text-xs text-white">
 ...
 className="font-mono text-xs border-border/70 bg-card shadow-modern text-white" />
 </div>
 </CardContent>
 </Card>
 </div>
 ...
 <div className="bg-card border border-border/80 rounded-2xl w-full max-w-md shadow-2xl p-6 space-y-4 animate-in zoom-in-95 duration-200">
 <div className="flex items-center justify-between">
