      ...
      <div className="relative z-10 max-w-2xl w-full px-6 py-16 md:py-24 pt-32 flex flex-col space-y-8 items-center text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Your commitment has been saved in our database. We've reserved tree ID <span className="font-bold text-primary">{treeId}</span> for you!
          </p>
        </div>
        ...
        >
          <div className="p-8 sm:p-12 bg-radial-gradient border border-white/10 rounded-3xl space-y-8 text-center relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-2 pt-6 border-t border-white/10 text-left max-w-md mx-auto">
              <div className="space-y-1">
                <span className="block text-[9px] font-bold uppercase tracking-wider text-white/50">Unique Tree ID</span>
                <span className="block text-xs font-bold text-[#84BABF] font-mono">{treeId}</span>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                <span className="block text-[9px] font-bold uppercase tracking-wider text-white/50">Tree Name</span>
