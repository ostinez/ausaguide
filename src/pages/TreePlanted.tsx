...
export default function TreePlantedPage() {
 ...
 Your commitment has been saved in our database. We've reserved tree ID <span className="font-bold text-[#0D6F73]">{treeId}</span> for you!
 </p>
 </div>
 ...
 <span className="block text-xs font-bold text-[#0D6F73] font-mono">{treeId}</span>
 </div>
 <div className="space-y-1">
