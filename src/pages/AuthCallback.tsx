...
export default function AuthCallbackPage() {
 ...
 className="mt-2 w-full py-2.5 rounded-xl bg-linear-to-r from-[#0D6F73] to-[#0D6F73] text-white text-xs font-bold shadow-lg"
 >
 Back to Log In
 </button>
 </div>
 ...
 <Spinner className="size-8 text-[#0D6F73] animate-spin mx-auto" />
