...
export default function AdminBookings() {
 ...
 <tr key={b.id} className="hover:bg-card shadow-modern transition-colors">
 ...
 className={`bg-transparent border border-white/10 text-xs px-2 py-0.5 rounded-lg focus:border-brand/30 bg-card font-bold uppercase tracking-wider
