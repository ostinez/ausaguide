...
export default function AdminDashboard() {
 ...
 <Card className="border-white/5 bg-card rounded-2xl hover:shadow-lg hover:shadow-modern-glow transition-all duration-300 border">
 ...
 <Link to="/admin/users" className="text-xs font-semibold text-brand hover:text-brand inline-flex items-center gap-1.5 hover:underline">
 View All Users
