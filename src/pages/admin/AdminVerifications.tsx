...
export default function AdminVerifications() {
 ...
 className="pl-10 border-white/5 bg-card focus:border-brand/30 text-white rounded-xl placeholder-white/30 text-xs h-10" 
 />
 </div>
 ...
 size="sm" 
 variant="outline" 
 className="rounded-full border-white/10 hover:bg-card shadow-modern hover:text-white transition-all text-xs h-9 px-4 shrink-0"
 >
 {loading ? (
 <Loader2 className="size-3.5 mr-2 animate-spin text-brand" />
 ) : (
 "Reload Applications"
 )}
 </Button>
 ...
 <div className="border border-white/5 rounded-2xl bg-card overflow-hidden ">
 ...
 <tr key={user.id} className="hover:bg-card shadow-modern transition-colors">
 ...
 className="text-[#0D6F73] hover:text-[#0D6F73]/80 font-bold p-0 text-xs h-auto flex items-center gap-1"
 >
 ...
 className="h-8 border-white/5 bg-card focus:border-brand/30 text-white rounded-lg placeholder-white/20 text-xs"
 />
 <Button
 onClick={() => handleSaveNote(user.id)}
 disabled={savingNoteId === user.id}
 className="h-8 bg-brand/15 hover:bg-brand/15 px-3 text-[10px] rounded-lg shrink-0"
 >
 ...
 <div className="relative w-full max-w-md border border-white/10 bg-card rounded-2xl p-6 shadow-2xl space-y-4">
 <div>
 ...
 className="border-white/5 bg-card shadow-modern focus:border-red-500/30 text-white rounded-xl placeholder-white/20 text-xs min-h-[100px]"
 />
 </div>
 ...
 className="rounded-xl border-white/10 text-xs h-9 px-4 hover:bg-card shadow-modern text-white"
 >
 Cancel
 </Button>
 <Button
