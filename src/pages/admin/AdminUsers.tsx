...
export default function AdminUsers() {
 ...
 <tr key={user.id} className={`hover:bg-card shadow-modern transition-colors ${user.banned ? "bg-red-500/5 hover:bg-red-500/10" : ""}`}>
 ...
 ${user.role === "host" ? "bg-brand/15 border-brand/30 text-brand" : ""}
 ${user.role === "traveler" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : ""}
 ${!user.role ? "bg-card shadow-modern border-white/10 text-white/40" : ""}
 `}>
 {user.role || "traveler"}
 </span>
 </td>
 ...
 className="bg-transparent border border-white/10 text-white/80 text-xs px-2.5 py-1 rounded-lg focus:border-brand/30 bg-card"
 >
