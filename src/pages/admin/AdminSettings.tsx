...
export default function AdminSettings() {
 ...
 <Settings className="size-8 text-brand" />
 System Settings
 </h1>
 ...
 <div className="border border-white/5 rounded-2xl bg-card p-6 space-y-6 ">
 {/* Commission Rate */}
 ...
 className="border-white/5 bg-card shadow-modern focus:border-brand/30 text-white rounded-xl text-xs h-10 w-32"
 />
 ...
 <div className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-card shadow-modern">
 <div>
 ...
 ${maintenanceMode ? "bg-red-500" : "bg-card shadow-modern"}
 `}
 >
 <span
 ...
 className="w-full border border-white/5 bg-card shadow-modern focus:border-brand/30 text-white rounded-xl text-xs h-10 px-3"
 >
 ...
 placeholder="0x..."
 className="border-white/5 bg-card shadow-modern focus:border-brand/30 text-white rounded-xl text-xs h-10 font-mono"
 />
 </div>
 ...
 onClick={handleSave}
 disabled={saving}
 className="bg-brand/15 hover:bg-brand/15 text-white font-bold rounded-xl text-xs h-10 px-5 flex items-center gap-1.5"
 >
 {saving ? (
