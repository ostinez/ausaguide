...
export default function AdminDashboardTest() {
 return (
 <div className="min-h-screen bg-card text-white flex items-center justify-center p-6">
 {/* Ambient Glow */}
 <div className="pointer-events-none fixed inset-0 overflow-hidden">
 <div className="absolute -top-40 left-1/2 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-brand/15 blur-3xl" />
 </div>

 <div className="relative z-10 w-full max-w-md border border-white/10 bg-card shadow-modern rounded-2xl p-8 shadow-2xl text-center space-y-6">
 <div className="flex size-14 items-center justify-center rounded-2xl bg-brand/15 text-brand mx-auto">
 ...
 <Link to="/admin/dashboard" className="text-xs text-brand hover:underline font-semibold">
