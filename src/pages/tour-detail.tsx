...
export default function TourDetailPage() {
 ...
 <LaserFlow
 colors={["#0D6F73", "#0D6F73", "#84BABF", "#84BABF"]}
 opacity={0.5}
 ...
 className="relative group aspect-video cursor-pointer overflow-hidden rounded-xl border border-border bg-card transition-all duration-300 hover:border-primary/50"
 >
 <img 
 src={imgUrl} 
 ...
 boxShadow: "0 0 40px rgba(13, 111, 115, 0.12) inset",
 }}
 >
 {/* Glow ring */}
 <div className="flex size-16 items-center justify-center rounded-full bg-primary/10 ring-1 ring-primary/30 shadow-[0_0_24px_rgba(13, 111, 115,0.35)]">
