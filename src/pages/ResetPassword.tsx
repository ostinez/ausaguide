...
export default function ResetPasswordPage() {
 ...
 <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[500px] w-[500px] rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/20 blur-[120px]" />
 <div className="absolute bottom-0 right-0 h-[400px] w-[400px] rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 blur-[100px]" />
 </div>

 <div className="relative z-10 w-full max-w-md space-y-6">
 {/* Header */}
 <div className="text-center space-y-1">
 <p className="text-xs font-semibold tracking-widest text-[#0D6F73] uppercase">AusaGuide</p>
 ...
 <div className="rounded-2xl border border-white/10 bg-card shadow-modern p-6 shadow-2xl space-y-5">
 {success ? (
 ...
 className="mt-2 w-full py-2.5 rounded-xl bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold shadow-lg hover:opacity-90 transition"
 >
 Go to Login Now
 </button>
 </div>
 ...
 <Loader2 className="size-8 text-[#0D6F73] animate-spin" />
 <div>
 <h2 className="text-base font-bold text-white">Verifying reset link...</h2>
 <p className="text-xs text-gray-400 mt-1">
 If this takes too long, your link may have expired.{" "}
 <button
 className="text-[#0D6F73] underline underline-offset-2"
 ...
 <div className="rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 p-3">
 <KeyRound className="size-7 text-[#0D6F73]" />
 </div>
 </div>
 ...
 className="w-full rounded-xl border border-white/10 bg-card shadow-modern px-4 py-3 pr-11 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0D6F73]/50 transition"
 />
 <button
 type="button"
 ...
 type="submit"
 disabled={loading}
 className="w-full py-3 rounded-xl bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold shadow-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
 >
 {loading ? (
 <>
 ...
 <button
 onClick={() => navigate("/auth")}
 className="text-[#0D6F73] font-semibold hover:underline underline-offset-2"
 >
 Sign in
 </button>
 </p>
