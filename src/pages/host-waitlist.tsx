...
export default function HostWaitlistPage() {
 ...
 {success ? (
 <div className="rounded-3xl border border-white/10 p-8 bg-card shadow-modern shadow-2xl text-center space-y-6 animate-in fade-in zoom-in duration-300">
 <div className="inline-flex size-16 items-center justify-center rounded-full bg-teal/10 border border-teal/20 text-[#0D6F73]">
 ...
 Thank you for applying to host with us! We have sent a confirmation email to <span className="text-[#0D6F73] font-semibold">{email}</span>. We'll be in touch as soon as we launch hosting in your area.
 </p>
 </div>
 <button
 onClick={() => window.location.href = "/"}
 className="w-full py-3 rounded-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold shadow-lg hover:shadow-[0_4px_20px_rgba(13, 111, 115,0.4)] transition duration-300"
 >
 Return Home
 </button>
 </div>
 ) : (
 <div className="rounded-3xl border border-white/10 p-8 bg-card shadow-modern shadow-2xl space-y-6">
 <div className="text-center space-y-2">
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 text-xs font-semibold text-[#0D6F73] mb-2">
 ...
 className="w-full bg-card shadow-modern border border-white/10 rounded-xl pl-11 pr-4 py-3 text-sm text-white focus:outline-none focus:border-[#0D6F73] transition-colors"
 />
 </div>
 </div>
 ...
 className="w-full bg-card shadow-modern border border-white/10 rounded-xl pl-11 pr-4 py-3 text-sm text-white focus:outline-none focus:border-[#0D6F73] transition-colors resize-none"
 />
 </div>
 </div>
 ...
 type="submit"
 disabled={submitting}
 className="w-full mt-2 py-3 rounded-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold shadow-lg hover:shadow-[0_4px_20px_rgba(13, 111, 115,0.4)] disabled:opacity-50 transition duration-300 flex items-center justify-center gap-2"
 >
 {submitting ? (
 <>
