...
export default function SettingsPage() {
 ...
 {/* Content Panel */}
 <form onSubmit={handleSave} className="rounded-2xl border border-border bg-card shadow-modern p-6">
 {activeTab === "personal" && (
 ...
 {uploadingAvatar && (
 <div className="absolute inset-0 flex items-center justify-center rounded-full bg-black/60 -[1px]">
 ...
 <div key={item.id} className="flex items-start justify-between rounded-xl border border-border/50 bg-card shadow-modern px-5 py-4">
 <div>
 ...
 <div className="flex flex-col sm:flex-row items-center gap-6 justify-center py-2 bg-card shadow-modern rounded-lg p-4">
 {/* QR Code */}
 ...
 <div className="rounded-xl border border-border bg-card shadow-modern p-5 space-y-3 flex flex-col justify-between">
 <div>
 ...
 className="text-xs w-full flex items-center justify-center gap-1.5 bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon hover:bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/95 text-white"
 >
