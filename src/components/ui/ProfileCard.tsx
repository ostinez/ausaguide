...
export default function ProfileCard({
 ...
 className="relative z-10 w-full max-w-[340px] rounded-3xl border border-white/10 p-6 bg-card shadow-modern shadow-2xl flex flex-col items-center select-none cursor-pointer overflow-hidden transition-colors duration-300 hover:border-white/15"
 style={{
 rotateX,
 rotateY,
 scale,
 ...
 className={`relative size-32 rounded-full p-[3px] bg-gradient-to-br from-[#0D6F73] to-[#0D6F73] shadow-[0_8px_32px_rgba(13, 111, 115,0.3)] mb-6 transition-transform duration-300 ${
 ...
 />
 {/* Active status dot */}
 <div className="absolute bottom-1 right-1 size-4 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon border-2 border-[#121214]" />
 </div>
 ...
 {/* Status box */}
 <div className="py-2 px-3 rounded-full bg-card shadow-modern border border-white/5 inline-block mx-auto text-xs font-semibold text-[#0D6F73] leading-none">
 {status}
 </div>
 </div>
 )}
 ...
 className="mt-6 w-full py-3 rounded-xl bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white text-sm font-bold flex items-center justify-center gap-2 hover:shadow-[0_4px_20px_rgba(13, 111, 115,0.4)] transition-all duration-300"
