...
export function ProfileCompletionBanner() {
 ...
 <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-[#1a1a24]/90 ">
 {/* Progress bar */}
 <div className="h-0.5 bg-card shadow-modern">
 <div
 className="h-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] transition-all duration-700"
 style={{ width: `${pct}%` }}
 />
 </div>
 ...
 {/* Icon */}
 <div className="shrink-0 size-9 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/20 flex items-center justify-center">
 <UserCircle className="size-5 text-[#0D6F73]" />
 </div>
 ...
 <Link
 to="/profile/edit"
 className="shrink-0 flex items-center gap-1 rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon hover:bg-[#6b47d6] text-white text-[11px] font-semibold px-3 py-1.5 transition-colors"
 >
 ...
 className="shrink-0 p-1.5 rounded-full text-white/40 hover:text-white/80 hover:bg-card shadow-modern transition-colors"
 ...
 done ? "text-[#0D6F73]" : "text-white/20"
 )}
 />
