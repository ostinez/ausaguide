...
export default function Dropzone({
 ...
 : "border-border hover:border-primary/50 bg-card shadow-modern hover:bg-card shadow-modern"
 )}
 >
 <input
 type="file"
 ...
 <div key={file.id} className="relative flex flex-col rounded-xl border border-border bg-card shadow-modern p-2.5 shadow-sm">
