...
export function HostCardCarousel({
 ...
 <div className="absolute right-3 top-3 rounded-full bg-black/60 px-2 py-0.5 text-[10px] font-medium text-white border border-border select-none">
 ...
 className="absolute left-3 top-1/2 -translate-y-1/2 flex size-8 items-center justify-center rounded-full bg-black/60 text-white border border-border opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-primary/95 hover:scale-105"
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 flex size-8 items-center justify-center rounded-full bg-black/60 text-white border border-border opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-primary/95 hover:scale-105"
