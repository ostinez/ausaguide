...
export function CookieConsent() {
 ...
 return (
 <div role="status" aria-live="polite" className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-md bg-card border border-primary/40 rounded-2xl p-5 shadow-2xl z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
