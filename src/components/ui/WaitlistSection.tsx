...
export function WaitlistSection({ defaultInterest }: WaitlistSectionProps) {
 ...
 <Mail className="size-6 text-[#0D6F73]" />
 ...
 {success ? (
 <div className="p-6 rounded-2xl bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 text-center space-y-3">
 <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/15 text-[#0D6F73] border border-[#0D6F73]/30">
 ...
 disabled={submitting}
 className="size-4 rounded border-border bg-black/45 text-primary focus:ring-primary accent-[#0D6F73]"
 />
 <span className="group-hover:text-white transition-colors flex items-center gap-1.5">
 <TreePine className="size-3.5 text-[#0D6F73]" /> Reforestation & Tree Planting
 </span>
 </label>
 ...
 />
 <span className="group-hover:text-white transition-colors flex items-center gap-1.5">
 <HeartPulse className="size-3.5 text-[#0D6F73]" /> Guide Mental Health Sponsorships
 </span>
 </label>
 </div>
 </div>
 ...
 >
 <div className="w-full h-11 flex items-center justify-center gap-1.5 text-xs font-bold text-white bg-card">
