...
function ReviewCard({
 ...
 return (
 <div className="group relative flex items-start gap-4 rounded-2xl border border-border/50 bg-card shadow-modern p-4 transition-all hover:border-primary/30 hover:bg-card shadow-modern hover:shadow-md hover:shadow-primary/5">
 {/* Left accent bar */}
