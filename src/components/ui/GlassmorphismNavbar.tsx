...
export function GlassmorphismNavbar({ className, ...props }: GlassmorphismNavbarProps) {
 ...
 className={cn(
 "mx-auto flex max-w-7xl items-center justify-between transition-all duration-500 rounded-full border border-border shadow-2xl ",
 scrolled || !isLanding
 ? "bg-card shadow-modern shadow-black/45 py-2.5 px-6"
 : "bg-card shadow-modern shadow-black/20 py-3.5 px-8",
 className
 )}
 {...props}
 >
 ...
 width={140}
 height={28}
 className="h-7 w-auto block object-contain transition-all duration-300 group-hover:drop-shadow-[0_0_8px_rgba(13, 111, 115,0.6)]"
 onError={(e) => {
 ...
 <Globe className="size-6 text-[#0D6F73]" />
 <span className="text-xl font-bold tracking-tight bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] bg-clip-text text-transparent">
 Ausaguide
 </span>
 </div>
 </Link>
 ...
 {isActive(link.href) && (
 <span className="absolute bottom-1.5 left-1/2 -translate-x-1/2 h-1 w-5 rounded-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73]" />
 )}
 </span>
 </Link>
 ))}
 ...
 <Link
 to="/messages"
 className="relative p-1.5 rounded-full hover:bg-card shadow-modern text-white/70 hover:text-white transition-colors"
 title="Messages"
 >
 <MessageSquare className="size-5" />
 {unreadCount > 0 && (
 <span className="absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon text-[9px] text-white font-black animate-pulse">
 {unreadCount}
 </span>
 )}
 </Link>
 ...
 <button className="flex items-center gap-2 rounded-full border border-border bg-accent/ px-4 py-1.5 hover:bg-accent/ hover:border-[#0D6F73]/40 transition-all duration-300 group cursor-pointer">
 {/* Avatar circle */}
 <span className="flex size-7 items-center justify-center rounded-full bg-gradient-to-br from-[#0D6F73] to-[#0D6F73] text-xs font-bold text-white shrink-0">
 {userInitials}
 </span>
 ...
 align="end"
 sideOffset={8}
 className="w-56 bg-card shadow-modern border border-border rounded-2xl shadow-2xl shadow-black/50 p-1.5"
 >
 <DropdownMenuLabel className="px-3 py-2.5">
 <p className="text-sm font-bold text-white truncate">{profile?.full_name || "Account"}</p>
 <p className="text-xs text-[#0D6F73] font-medium capitalize mt-0.5">{userRole}</p>
 </DropdownMenuLabel>
 ...
 <Button
 size="sm"
 className="bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white border-0 hover:opacity-90 hover:scale-105 transition-all duration-300 font-bold shadow-md shadow-[#0D6F73]/30 rounded-full px-5"
 >
 Sign Up
 </Button>
 </Link>
 ...
 <SheetContent
 side="right"
 className="w-72 bg-card shadow-modern border-l border-border p-6 rounded-l-3xl flex flex-col shadow-2xl"
 >
 ...
 <span className="font-bold bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] bg-clip-text text-transparent">Ausaguide</span>
 </div>
 </SheetTitle>
 </SheetHeader>
 ...
 isActive(link.href)
 ? "bg-gradient-to-r from-[#0D6F73]/20 to-[#0D6F73]/20 text-[#0D6F73] border border-[#0D6F73]/20"
 ...
 <span className="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-[#0D6F73] to-[#0D6F73] text-sm font-bold text-white shrink-0">
 {userInitials}
 </span>
 <div className="min-w-0">
 <p className="text-sm font-bold text-white truncate">{profile.full_name}</p>
 <p className="text-xs text-[#0D6F73] capitalize">{userRole}</p>
 </div>
 </div>
 )}
 ...
 <div className="flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-[#0D6F73] bg-carbon-dark shadow-modern-glow border border-brand text-brand hover:bg-carbon/10 border border-[#0D6F73]/20 rounded-full justify-center">
 ...
 <Button className="w-full bg-gradient-to-r from-[#0D6F73] to-[#0D6F73] text-white border-0 hover:opacity-90 font-semibold rounded-full py-5">
 Sign Up
 </Button>
 </Link>
 </div>
