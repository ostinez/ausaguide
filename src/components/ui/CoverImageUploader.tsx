...
export default function CoverImageUploader({
 ...
 : "border-dashed border-border hover:border-primary/50 bg-card shadow-modern hover:bg-card shadow-modern",
 ...
 <div className="flex items-center gap-2 bg-card shadow-modern rounded-full px-4 py-2 text-white text-sm font-semibold border border-white/20">
 ...
 {/* Cover badge */}
 <div className="absolute bottom-3 left-3 z-10 rounded-full bg-black/60 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-widest text-white border border-white/20 ">
 Cover Photo
 </div>
 </>
 ) : (
