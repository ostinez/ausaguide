...
export function SkeletonCard({ className }: { className?: string }) {
 return (
 <div className={cn("relative overflow-hidden rounded-2xl border border-white/5 bg-card shadow-modern p-4 space-y-4 shadow-xl", className)}>
 <ShimmerOverlay />
...
export function SkeletonPostCard({ className }: { className?: string }) {
 return (
 <div
 className={cn("relative overflow-hidden rounded-2xl border border-white/5 p-4 space-y-4 bg-card shadow-modern shadow-xl", className)}
 aria-hidden="true"
 >
 <ShimmerOverlay />
 {/* Author row */}
...
export function SkeletonTourDetail() {
 ...
 <ShimmerOverlay />
 <div className="absolute top-6 left-6 h-9 w-20 rounded-full bg-card shadow-modern" />
 <div className="absolute bottom-7 left-6 space-y-3 w-2/3">
 <div className="h-4 w-32 rounded-full bg-card shadow-modern" />
 <div className="h-8 w-64 rounded-full bg-card shadow-modern" />
 <div className="flex gap-4">
 <div className="h-3 w-20 rounded-full bg-card shadow-modern" />
 <div className="h-3 w-20 rounded-full bg-card shadow-modern" />
 <div className="h-3 w-20 rounded-full bg-card shadow-modern" />
 </div>
 </div>
 ...
 <div className="relative overflow-hidden rounded-2xl border border-white/5 p-5 space-y-4 h-80 bg-card shadow-modern shadow-xl">
 <ShimmerOverlay />
...
export function SkeletonStatCard({ className }: { className?: string }) {
 return (
 <div
 className={cn("relative overflow-hidden rounded-xl border border-white/5 p-5 space-y-3 bg-card shadow-modern shadow-xl", className)}
 aria-hidden="true"
 >
 <ShimmerOverlay />
...
export function SkeletonTable({ rows = 5, cols = 4 }: { rows?: number; cols?: number }) {
 return (
 <div
 className="relative overflow-hidden rounded-xl border border-white/5 bg-card shadow-modern shadow-xl"
 aria-hidden="true"
 >
 <ShimmerOverlay />
 {/* Header row */}
...
export function SkeletonProfile() {
 ...
 <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-card shadow-modern p-5 space-y-4 shadow-xl">
 <ShimmerOverlay />
 ...
 <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-card shadow-modern p-6 space-y-4 shadow-xl">
 <ShimmerOverlay />
