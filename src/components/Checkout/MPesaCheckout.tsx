      ...
      <div
        className={cn(
          "flex size-7 items-center justify-center rounded-full border text-xs font-bold transition-all duration-300",
            ...
            : active
            ? "border-primary bg-primary/20 text-primary shadow-[0_0_10px_rgba(127,90,240,0.4)]"
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "review" && (
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    maxLength={16}
                    className={cn(
                      "h-11 rounded-xl border-white/10 bg-white/5 pl-10 text-foreground placeholder:text-muted-foreground/60 focus-visible:ring-primary/50",
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(135deg, #7F5AF0 0%, #6B46E0 100%)",
                  boxShadow: "0 4px 20px rgba(127,90,240,0.35)",
                }}
              >
              ...
              <div className="w-full space-y-2 rounded-xl border border-white/8 bg-white/[0.02] p-4 text-left text-sm">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 text-muted-foreground">
                    <span className="flex size-4 shrink-0 items-center justify-center rounded-full bg-white/5 text-[10px]">{i + 2}</span>
                    {instruction}
                  </div>
                ))}
              </div>
          ...
          {step === "failed" && (
            ...
            >
              ...
              <button
                onClick={handleRetry}
                className="flex items-center gap-2 rounded-xl border border-white/10 px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-white/5"
              >
          ...
          {step === "timeout" && (
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleRetry}
                  className="flex items-center gap-1.5 rounded-xl border border-white/10 px-4 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-white/5"
                >
