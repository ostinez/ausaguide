...
export function CheckoutStepper({ steps, current }: CheckoutStepperProps) {
 ...
 done && "bg-primary border-primary text-white shadow-[0_0_12px_rgba(13, 111, 115,0.5)]",
 active && "border-primary text-primary bg-primary/10 shadow-[0_0_16px_rgba(13, 111, 115,0.4)]",
