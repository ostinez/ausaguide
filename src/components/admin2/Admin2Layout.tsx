...
export default function Admin2Layout() {
 ...
 className="hidden md:flex p-1 rounded-md hover:bg-card shadow-modern text-gray-400 hover:text-white transition-colors"
 >
 ...
 : "text-gray-300 hover:bg-card shadow-modern hover:text-white"
