 ...
 */
 ...
 context.fillStyle = `rgba(13, 111, 115, ${0.8 * (1 - t)})`
 context.fill()

 // Inner solid core
 context.beginPath()
 context.arc(this.width / 2, this.height / 2, radius, 0, Math.PI * 2)
 context.fillStyle = "#0D6F73"
 ...
 tourPin.innerHTML = `
 <div style="background: #0D6F73; border: 2px solid white; border-radius: 50%; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; box-shadow: 0 3px 6px rgba(0,0,0,0.4); cursor: pointer;">
 ...
 return (
 <div className={cn("relative overflow-hidden rounded-2xl border border-border/80 bg-card shadow-modern shadow-lg", className)}>
 {/* Map display */}
 <div ref={mapContainerRef} className="w-full h-72 md:h-96" />

 {/* Floating location status bar */}
 <div className="absolute bottom-4 left-4 right-4 z-10 flex flex-col gap-2 rounded-xl border border-border/80 bg-background/95 p-3.5 shadow-xl animate-in slide-in-from-bottom duration-500">
