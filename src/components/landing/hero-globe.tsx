...
function GlobeFallback() {
 ...
 width: "min(85%, 600px)",
 aspectRatio: "1",
 boxShadow: `0 0 80px rgba(13, 111, 115, 0.15)`,
...
export function HeroGlobe() {
 ...
 deletingSpeed={30}
 loop={true}
 textColors={["#0D6F73", "#0D6F73", "#FFFFFE"]}
 showCursor={true}
 cursorCharacter="|"
 ...
 <div
 className={cn(
 "flex items-center rounded-full border border-border bg-card shadow-modern shadow-2xl transition-all duration-300 ease-in-out overflow-hidden cursor-pointer",
 isSearchActive
 ? "w-[250px] px-4 h-12"
 : isMobile
 ? "w-14 h-14 justify-center px-0 hover:border-[#0D6F73]/40"
 : "w-12 h-12 justify-center px-0 hover:border-[#0D6F73]/40"
 )}
 ...
 <p className="text-[#0D6F73] text-xs sm:text-sm md:text-base font-bold tracking-wide uppercase">
 ...
 {isMobile && (
 <div className="flex flex-col items-center gap-1 mt-3 text-[10px] uppercase tracking-widest text-[#0D6F73]/80 animate-bounce">
