...
export default function GlobeVisual() {
 ...
 return `<div style="background:#16161A;border:1px solid #0D6F73;border-radius:8px;padding:8px 12px;color:#FFFFFE;font-family:Inter,sans-serif;font-size:13px;font-weight:500;pointer-events:none;">${ADMIN}</div>`
 }, [])
