...
const CATEGORY_IMAGES: Record<TourCategory, string> = {
  food: "/src/assets/images/tours/street_food.png", // Nairobi street food
  nature: "/src/assets/images/tours/safari.png", // Maasai Mara safari
  culture: "/src/assets/images/tours/village.png", // Traditional village
  adventure: "/src/assets/images/tours/safari.png", // Safari adventures
  city: "/src/assets/images/tours/village.png", // Village walks
  nightlife: "/src/assets/images/tours/street_food.png", // Food markets
}

const CATEGORY_GALLERIES: Record<TourCategory, string[]> = {
  food: [
    "/src/assets/images/tours/street_food.png",
  ...
  nature: [
    "/src/assets/images/tours/safari.png",
  ...
  culture: [
    "/src/assets/images/tours/village.png",
...
const TITLE_IMAGES: Record<string, string> = {
  "nairobi street food safari": "/src/assets/images/tours/street_food.png",
  "nairobi national park safari": "/src/assets/images/tours/safari.png",
  "kibera community walk": "/src/assets/images/tours/village.png",
  "nairobi night food tour": "/src/assets/images/tours/street_food.png",
}
