...
const CATEGORY_IMAGES: Record<TourCategory, string> = {
 food: "/images/tours/street_food.webp", // Nairobi street food
 nature: "/images/tours/safari.webp", // Maasai Mara safari
 culture: "/images/tours/village.webp", // Traditional village
 adventure: "/images/tours/safari.webp", // Safari adventures
 city: "/images/tours/village.webp", // Village walks
 nightlife: "/images/tours/street_food.webp", // Food markets
}

const CATEGORY_GALLERIES: Record<TourCategory, string[]> = {
 food: [
 "/images/tours/street_food.webp",
...
const TITLE_IMAGES: Record<string, string> = {
 "nairobi street food safari": "/images/tours/street_food.webp",
 "nairobi national park safari": "/images/tours/safari.webp",
 "kibera community walk": "/images/tours/village.webp",
 "nairobi night food tour": "/images/tours/street_food.webp",
}
